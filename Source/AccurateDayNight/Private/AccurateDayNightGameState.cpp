...
AAccurateDayNightGameState::AAccurateDayNightGameState()
	: AGameStateBase()
{
...
void AAccurateDayNightGameState::SetGameTimeMultiplier(float Value)
{
...
float AAccurateDayNightGameState::GetGameTimeMultiplier()
{
	return GameTimeMultiplier;
}

void AAccurateDayNightGameState::SetGameStartDateTime(const FDateTime& DateTime)
{
...
float  AAccurateDayNightGameState::GetTimeMuliplier()
{
...
void AAccurateDayNightGameState::GameSpeedUp()
{
...
void AAccurateDayNightGameState::GameSpeedDown()
{
	bool bNeedBroadcast = true;
...
TEnumAsByte<EEDayNightCicle> AAccurateDayNightGameState::DefineDayNightCycle(const int32& NumMinutes)
{
...
TEnumAsByte<EEDayNightSchedule> AAccurateDayNightGameState::DefineDayNightSchedule(const int32& NumHours)
{
	if (NumHours < 3) {
...
float  AAccurateDayNightGameState::GetGameCurrentDaySeconds() {
	return FullDateTime.GetTimeOfDay().GetTotalSeconds();
}

float  AAccurateDayNightGameState::GetGameSolarTime() {
...
void AAccurateDayNightGameState::Tick(float DeltaTime)
{
...
void AAccurateDayNightGameState::SetDayNightTransitionTime(int32 Hour, int32 Minute)
{
...
FTimespan AAccurateDayNightGameState::GetDayNightTransitionTime() {
